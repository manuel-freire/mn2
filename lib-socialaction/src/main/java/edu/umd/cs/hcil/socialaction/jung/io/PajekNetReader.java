 ...
 * <ul>
 * <li> node ids (each must have a value from 1 to n, where n is the number of vertices)
 ...
 * </pre> 
 * 
 * Modified from JUNG v1.7.4 (edu.uci.ics.jung.io.PajekNetReader) to work with Prefuse.
 * 
...
public class PajekNetReader
{
     ...
     * using a <code>StringLabeller</code> with key <code>PajekNetReader.LABEL</code>.
     ...
     * in the graph's user data with key<code>PajekNetReader.LOCATIONS</code>.</p>
     */
     ...
     * stored in the graph's user data with key <code>PajekNetReader.LOCATIONS</code>.</p>
     */
