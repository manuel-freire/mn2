...
/**
 * Modified from VizsterLayout by Jeff Heer
 * 
 * From J. Heer and D. Boyd "Vizster: Visualizing online social networks" (doi:10.1109/INFVIS.2005.1532126):
 * <blockquote>"To optimize the layout, we parameterize the tension of the individual spring-edges by node connectivity.
 * Nodes with lower connectivity are given higher tension, causing singly-connected nodes to remain close to expanded
 * nodes and connected communities to assume higher 'orbits.' This additionally causes nodes with lower connectivity to
 * more closely 'tag-along' with their friends, reinforcing their limited connections. We currently assign spring
 * tension proportionally to the inverse logarithm of the degree of the edge's minimally connected node. As discussed
 * later, we also change spring tensions to improve the layout of inferred community
 * groupings." </blockquote> <blockquote>"To further improve the layout, extra-community edges are given weaker spring
 * forces, promoting the spatial separation of inferred communities." </blockquote>
 * 
 * @author Jeff Heer
 * @author Adam Perer
 * @author Cody Dunne
 */
public class SocNetLayout extends ForceDirectedLayout {
	...
	public SocNetLayout(SocialAction app, String g, boolean enforceBounds) {
