 ...
 */
package edu.umd.cs.hcil.socialaction.jung.algorithms;
 ...
 * </pre>
 * 
 * Modified from JUNG v1.7.4 (edu.uci.ics.jung.algorithms.IterativeProcess) to work with Prefuse.
 * 
...
public abstract class IterativeProcess {
	...
	/**
	 * Performs the iterative process. Note: this method does not return anything because Java does not allow mixing
	 * double, int, or objects
	 */
