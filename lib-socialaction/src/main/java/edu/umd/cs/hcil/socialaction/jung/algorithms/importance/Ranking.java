...
/**
 * Abstract data container for ranking objects. Stores common data relevant to both node and edge rankings, namely, the
 * original position of the instance in the list and the actual ranking score.
 * 
 * Modified from JUNG v1.7.4 (edu.uci.ics.jung.algorithms.importance.Ranking) to work with Prefuse.
 * 
 * @author Scott White
 * @author Adam Perer
 */
